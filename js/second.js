...
let arduinoValuesSan = {
  ...
  sanShim: "param_send_sanShim_xxx",
  sanWind: "param_send_sanWind_xxx",
  sanSliderShim: "param_send_sanSliderShim_xxx",
  sanWindMotion: "param_send_sanWindMotion_xxx",
  sanShimMotion: "param_send_sanShimMotion_xxx",
  checkboxTempHum: "param_send_checkboxTempHum_xxx",
  sliderMinTemp: "param_send_sliderMinTemp_xxx",
  sliderMaxTemp: "param_send_sliderMaxTemp_xxx",
  sliderMinHum: "param_send_sliderMinHum_xxx",
  sliderMaxHum: "param_send_sliderMaxHum_xxx",
  //спальня
  bedroomSpot: "pinout_xxx_bedroomSpot",
  bedroomTrack: "pinout_xxx_bedroomTrack",
  bedroomShim: "param_send_bedroomShim_xxx",
  bedroomSliderShim: "param_send_bedroomSliderShim_xxx",
  bedroomBra: "pinout_xxx_bedroomBra",
  bedroomLamp: "pinout_xxx_bedroomLamp",
  bedroomCase: "param_send_bedroomCase_xxx",
  bedroomSliderCase: "param_send_bedroomSliderCase_xxx",
  //дедская
  childrenSpot: "pinout_xxx_childrenSpot",
  childrenTrack: "pinout_xxx_childrenTrack",
  childrenShim: "param_send_childrenShim_xxx",
  childrenSliderShim: "param_send_childrenSliderShim_xxx",
  //кабинет
  ...
  //прачка
  sanWindLaundry: "param_send_sanWindLaundry_xxx",
  checkboxTempHumLaundry: "param_send_checkboxTempHumLaundry_xxx",
  sliderMinTempLaundry: "param_send_sliderMinTempLaundry_xxx",
  sliderMaxTempLaundry: "param_send_sliderMaxTempLaundry_xxx",
  sliderMinHumLaundry: "param_send_sliderMinHumLaundry_xxx",
  sliderMaxHumLaundry: "param_send_sliderMaxHumLaundry_xxx",
  laundrySpot: "pinout_xxx_laundrySpot",
  laundryBra: "pinout_xxx_laundryBra",
  laundryMotionBra: "param_send_laundryMotionBra_xxx",
};
